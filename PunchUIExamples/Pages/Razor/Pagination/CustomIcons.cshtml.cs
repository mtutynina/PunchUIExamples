// -----------------------------------------------------------------------
// <copyright file="CustomIcons.cshtml.cs" company="Mariya Tutynina">
...
namespace PunchUIExamples.Pages.Razor.Pagination
{
    ...
    /// Page Model.
    /// </summary>
    public class CustomIconsModel : PageModel
    {
        private readonly PunchManager manager;

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomIconsModel"/> class.
        /// </summary>
        /// <param name="manager">Data access manager.</param>
        public CustomIconsModel(PunchManager manager)
        {
